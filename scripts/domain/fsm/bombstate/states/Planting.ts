...
export class C4PlantingState implements IBombStateHandler {
    
    readonly stateTag = BombStateEnum.Planting;
    ...
    private onItemCompleteUse(ev: ItemCompleteUseAfterEvent) {
        ...
        BombStateManager.updateState(new C4PlantedState({ dimension, ...location }));
    }
